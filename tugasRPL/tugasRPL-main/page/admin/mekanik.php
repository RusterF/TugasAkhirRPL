                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm mb-4">
                            <div class="card-header bg-secondary text-white">
                                <h2 class="text-center">Tambah Mekanik</h2>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        while ($data = mysqli_fetch_array($query)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success" href="./editMekanik.php?id=<?php echo $data['id']; ?>">Edit</a>
                                                    <a class="btn btn-danger" href="../../core/hapusMekanik.php?id=<?php echo $data['id']; ?>">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
